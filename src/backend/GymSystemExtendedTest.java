...
public class GymSystemExtendedTest {
    ...
    public static double testClassManagement() {
        ...
        try {
            ...
            if (registered && trainer.getListOfClasses().get(0).getAvailableSeats() == 0 && trainer.getListOfRegistrations().get(0).getKey().equals("M001C001")) {
                mark += 1.5;
            }
